...
const filteredMemo = memo.filter(
 ...
 // Fetch memo from API
  ...
  <MenuItem value="subjectk-1">subjectk-1</MenuItem>
  <MenuItem value="Subjectk-2">Subjectk-2</MenuItem>
  <MenuItem value="Subjectk-3">Subjectk-3</MenuItem>
  <MenuItem value="Subjectk-4">Subjectk-4</MenuItem>
  <MenuItem value="Subjectk-5">Subjectk-5</MenuItem>
  <MenuItem value="Subjectk-6">Subjectk-6</MenuItem>
</Select>
          <DialogActions>
